...
print(count_lower_upper("PDEU ROCKS AT EE DEPT"))
...
print(convert("pdeu ee ee rocks pdeu rocks python"))
...
print(count_alpha_digits("EE2025PDEU28"))
...
print(count_vowels("PDEU Rocks At EE"))
